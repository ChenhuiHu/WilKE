...
def append_to_file(file_path, string_to_append):
    try:
        ...
        print("String appended successfully to file ===> ", file_path)
    except Exception as e:
        print("Error while appending string:", e)
...
def compute_v(
    ...
    #if hparams.layers[0] < 7:
    #    delta = torch.zeros((model.config.n_embd,), requires_grad=True, device="cuda:0")
    #else:
    #    delta = torch.zeros((model.config.n_embd,), requires_grad=True, device="cuda:1")
